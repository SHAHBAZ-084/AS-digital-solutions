  ...
  items: [
    {
      ...
      description: 'Solutions are shaped around actual workflows, not generic templates.',
    },
    {
      id: 'custom-solutions',
      title: 'Custom Solutions',
      description: 'Every build can be tailored to the way a business operates and grows.',
    },
    {
      id: 'online-offline',
      title: 'Online & Offline Capability',
      description: 'Systems can be planned for connectivity gaps and real operating conditions.',
    },
    {
      id: 'scalable',
      title: 'Scalable Architecture',
      description: 'Clean structure helps the project evolve without starting over later.',
    },
    {
      id: 'modern-tech',
      title: 'Modern Technology',
      description: 'Current frameworks and tools support performance, maintainability, and speed.',
    },
    {
      id: 'long-term-support',
      title: 'Long-Term Support',
      description: 'Ongoing fixes, improvements, and iteration can continue after launch.',
    },
    {
      id: 'ai-ready',
      title: 'AI-Ready',
      description: 'Systems can be planned with room for useful automation and ML features.',
    },
  ],
}
