...
function CardIcon({ children }: { children: ReactNode }) {
  return (
    <AnimatedIcon className="flex h-10 w-10 shrink-0 items-center justify-center bg-white/15 text-white ring-1 ring-white/25">
      {children}
    </AnimatedIcon>
  )
}
...
function CheckIcon() {
  return (
    <svg className="mt-0.5 h-4 w-4 text-accent" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M20 6 9 17l-5-5"
        stroke="currentColor"
        strokeWidth="1.9"
  ...
  switch (icon) {
    case 'web':
      return (
        <svg {...common}>
          <path
            d="M4 7h16M7 4h10a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinejoin="round"
          />
    ...
    case 'ai':
      return (
        <svg {...common}>
          ...
          />
          <path
            d="M7.5 7.5l2 2M15.5 15.5l2 2M16.5 7.5l-2 2M8.5 15.5l-2 2"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
          />
    ...
    case 'custom':
      return (
        <svg {...common}>
          <path
            d="M20 12v4a2 2 0 0 1-2 2h-4M4 12V8a2 2 0 0 1 2-2h4"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
          />
...
/** Workshop service card — no tilt; quiet hover, header bar for hierarchy. */
