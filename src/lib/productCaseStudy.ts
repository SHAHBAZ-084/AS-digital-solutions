...
export function normalizeCaseStudy(raw: unknown): ProductCaseStudy {
  ...
  return {
    overview: typeof record.overview === 'string' ? record.overview : base.overview,
    client: typeof record.client === 'string' ? record.client : base.client,
    challenge: typeof record.challenge === 'string' ? record.challenge : base.challenge,
    solution: typeof record.solution === 'string' ? record.solution : base.solution,
...
export function syncProductImages(product: ProductItem): ProductItem {
  ...
  return {
    ...product,
    screenshot_url,
    case_study: { ...product.case_study, screenshot_urls: urls },
  }
}
